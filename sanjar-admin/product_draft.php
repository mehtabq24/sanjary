				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box d-sm-flex align-items-center justify-content-between">
							<div>
								<h4 class="mb-sm-0 font-size-18">Product Draft List </h4></div>
					...
					<div class="card">
						<div class="card-body">
							...
							<div id="datatable_wrapper" class="bloglisting dataTables_wrapper dt-bootstrap4 no-footer">
									...
									<div class="col-sm-12" style="overflow-y:auto;">
										<table id="datatable" class="table table-bordered">
											...
											<tbody>
												<?php
													  	$per_page = 10;
															$stmt = $conn->prepare("SELECT * FROM `product` WHERE status=2 ORDER BY id DESC");
															$stmt->execute();
                                ...
                                $sql = "SELECT * FROM `product` WHERE status=2 ORDER BY id DESC LIMIT $start,$per_page";
