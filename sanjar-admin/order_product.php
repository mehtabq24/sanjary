				...
				<div class="row">
					<div class="col-12">
						<div class="page-title-box d-sm-flex align-items-center justify-content-between">
							<h4 class="mb-sm-0">order_product<span style="color:black;margin-left:10px">Listing</span></h4>
						...
						<div class="card">
							<div class="card-body">
								...
								<div id="datatable_wrapper" class="bloglisting dataTables_wrapper dt-bootstrap4 no-footer">
											...
											<table id="datatable" class="table table-bordered dt-responsive nowrap w-100 dataTable no-footer dtr-inline" role="grid" aria-describedby="datatable_info" style="width: 1292px;">
												<thead>
													<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 307.5px;" aria-label="Position: activate to sort column ascending">Product Name</th>
                                                        ...
                                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 307.5px;" aria-label="Position: activate to sort column ascending">Price</th>
                                                        <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1" colspan="1" style="width: 307.5px;" aria-label="Position: activate to sort column ascending">Quantity</th>
												...
												<?php
															...
															$per_page = 10;
															$stmt = $conn->prepare("SELECT * FROM `order_product` ORDER BY id DESC");
															$stmt->execute();
									...
									$sql = "SELECT * FROM `order_product` ORDER BY id DESC LIMIT $start,$per_page";
                                    ...
                                    ?>   
                                                    ...
                                                    <td><img src="<?php echo $cta_image ?>" alt="<?php echo $cta_alt ?>" style="width:60px;"></td>
														...
														<td><?php echo $data['pro_category'] ?></td>
                                                        <td><?php echo $data['pro_price'] ?></td>
                                                        <td><?php echo $data['pro_qty'] ?></td>
                                                        <td><?php echo $data['pro_price'] ?></td>
														<td><a href="categoryUpdate.php?id=<?php echo $data['id']; ?>" class="btn btn-success"><i class="fas fa-edit"></i>
														</td>
														<td>
