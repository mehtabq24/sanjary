<!-- modal -->
<div class="modal fade" id="add_cart" aria-hidden="true" aria-labelledby="exampleModalToggleLabel" tabindex="-1">
  <div class="modal-dialog  modal-lg modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
        <h6 class="modal-title ml-5" id="exampleModalToggleLabel">&nbsp;&nbsp;The following items has been added to your cart:</h6>
      ...
      <div class="row">
          <div class="col-3">
              ...
              <div class="modal-subheading"> <h6>QUICK CART</h6></div>
             
          </div>
          <div class="col-9">
          <div class="modal-subheading"> <h6>YOUR ORDER</h6></div>
...
<footer class="pt-12 pb-5 footer bg-primary">
        <div class="container container-xxl">
            <div class="row">
                <div class="col-lg-4 mb-6 mb-lg-0">
                    <h2 class="fs-40 mb-3 text-white">We’re here to help.</h2>
                </div>
                <div class="col-sm-6 col-lg mb-6 mb-lg-0">
                    <h3 class="fs-14 mb-3 text-uppercase text-white letter-spacing-05">menu</h3>
                    <ul class="list-unstyled mb-0">
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Seatting</a>
                        </li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Tables</a></li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Decoration</a>
                        </li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Lighting</a>
                        </li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Gift Ideas</a>
                        </li>
                    </ul>
                </div>
                <div class="col-sm-6 col-lg mb-6 mb-lg-0">
                    <h3 class="fs-14 mb-3 text-uppercase text-white letter-spacing-05">about</h3>
                    <ul class="list-unstyled mb-0">
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Contact Us</a>
                        </li>
                        <li class="py-0"><a href="#"
                                class="text-gray hover-white lh-2 font-weight-500">Contributiors</a></li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Privacy</a></li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Sponsors</a>
                        </li>
                    </ul>
                </div>
                <div class="col-sm-6 col-lg mb-6 mb-lg-0">
                    <h3 class="fs-14 mb-3 text-uppercase text-white letter-spacing-05">follow us</h3>
                    <ul class="list-unstyled mb-0">
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Facebook</a>
                        </li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Pinterest</a>
                        </li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Instagram</a>
                        </li>
                        <li class="py-0"><a href="#" class="text-gray hover-white lh-2 font-weight-500">Twitter</a></li>
                    </ul>
                </div>
                <div class="col-sm-6 col-lg mb-6 mb-lg-0">
                    <h3 class="fs-14 mb-3 text-uppercase text-white letter-spacing-05">Instagram</h3>
                    <ul class="list-inline mb-2 d-flex">
                        <li class="list-inline-item mr-2">
                            <a href="#">
                                <img src="images/in_01.jpg" alt="Instagram 01">
                            </a>
                        </li>
                        <li class="list-inline-item mr-2">
                            <a href="#">
                                <img src="images/in_02.jpg" alt="Instagram 02">
                            </a>
                        </li>
                        <li class="list-inline-item">
                            <a href="#">
                                <img src="images/in_03.jpg" alt="Instagram 03">
                            </a>
                        </li>
                    </ul>
                    <a href="#" class="text-white py-1 fs-14 font-weight-500">@furnitor.trendy</a>
                </div>
            </div>
            <div class="mt-2 mt-md-7 row align-items-center">
                ...
                <ul class="list-inline mb-0 col-md-6 ml-md-auto text-md-right">
                    <li class="list-inline-item">
                        <a href="#"><img src="images/card_01.png" alt="Amex"></a>
                    </li>
                    <li class="list-inline-item">
                        <a href="#"><img src="images/card_02.png" alt="G-Pay"></a>
                    </li>
                    <li class="list-inline-item">
                        <a href="#"><img src="images/card_03.png" alt="Master Card"></a>
                    </li>
                    <li class="list-inline-item">
                        <a href="#"><img src="images/card_04.png" alt="Paypal"></a>
                    </li>
                    <li class="list-inline-item">
                        <a href="#"><img src="images/card_05.png" alt="D-Pay"></a>
                    </li>
                    <li class="list-inline-item">
    ...
    <div class="card border-0 pt-5 pb-7 h-100" id="get_updated_carProduct">
              ...
              <?php $cartTotal = 0;
                ...
                if ($total_cart_product > 0) {
                    ...
                    <div class="mb-6 d-flex">
                        <a href="javascript:void(0)" class="d-block mr-4" onclick="deleteCart(<?php echo $row['id'] ?>)"><i class="fal fa-times"></i></a>
                        <div class="media">
                            <div class="w-70px mr-4">
                                <img src="sanjar-admin/<?php echo $row['pro_img'] ?>" alt="Partridge Bar Stool">
                            </div>
                            <div class="media-body">
                                <p class="text-muted fs-12 mb-0 text-uppercase letter-spacing-05 lh-1 mb-1"><?php echo $row['pro_category'] ?></p>
                                <a href="#" class="font-weight-bold mb-3 d-block"><?php echo $row['pro_name'] ?></a>
                                <div class="d-flex align-items-center">
                                    <div class="input-group position-relative">
                                        <a href="javascript:void(0)" class="down position-absolute pos-fixed-left-center pl-2" onclick="removeQuantity(<?php echo $row['id'] ?>,'<?php echo $row['userid'] ?>')"><i
                                                class="far fa-minus"></i></a>
                                        <input type="number" class="w-100px px-6 text-center" id="change_qty" value="<?php echo $row['pro_qty'] ?>">
                                        <a href="javascript:void(0)" class="up position-absolute pos-fixed-right-center pr-2" onclick="addQuantity(<?php echo $row['id'] ?>,'<?php echo $row['userid'] ?>')"><i
                                                class="far fa-plus"></i>
                                        </a>
                                    </div>
                                    <p class="mb-0 ml-12 text-primary"><?php echo $row['pro_price'] ?>.00</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?php
                     $subTotal = $cartTotal + ($row["pro_price"] * $row["pro_qty"]);
                     $cartTotal= $subTotal+$shipping_charge;
                    } ?>
            </div>
                <div class="card-footer mt-auto border-0 bg-transparent px-6 pb-0 pt-5">
                    <div class="d-flex align-items-center mb-4">
                        <span class="font-weight-bold text-primary">Subtotal</span>
                        <span class="d-block ml-auto text-primary" id="change_subtotal"><?php echo $subTotal ?>.00</span>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <span class="font-weight-bold text-primary">Shipping</span>
                        <span class="d-block ml-auto text-primary">20.00</span>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <span class="font-weight-bold text-primary">Total</span>
                        <span class="d-block ml-auto text-primary" id="change_totalPrice"><?php echo $cartTotal ?>.00</span>
                    </div>
                ...
                <?php
                            ...
                            echo "there is no items in cart";
                        }   
  ...
  <script src="https://www.paypal.com/sdk/js?client-id=AfSDpNQQbh-Hs6pzu6lRos1RZivCLbU0eAQKV3-A_KQ7wV4tU5REg9ByXEMfRzIE1jzkxqs0UB6hGIzP&currency=USD"></script>
  ...
  submitHandler: function (form) {
    ...
    const total_amount = $('#pay_total').val();
      paypal.Buttons({
        style:{
          color:'blue',
          shape:'pill',  
        ...
        onApprove: (data, actions) => {
            ...
            // alert(`Transaction completed by ${transaction.status}: ${transaction.id}: ${transaction.payer}\n\nSee console for all available details`);
          
            window.location.replace("http://localhost/sanjary/payment_done.php");
        ...
        onCancel:function(data){
            window.location.replace("http://localhost/sanjary/payment_cancel.php");
        }
...
// function countCartprodcut() {
//   userid= $("#cart_userid").val();
//     alert(userid)
  
  
//   $.ajax({
//     url: 'include/cart_total.php',
//     type: 'post',
//     data: {
//       userid: userid,
//       btn: 'getCartproduct',
